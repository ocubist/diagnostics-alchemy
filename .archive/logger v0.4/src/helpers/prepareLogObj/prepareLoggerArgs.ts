...
import { PreparedLoggerArgs } from "../../types/PreparedLoggerArgsType";
...
export const prepareLoggerArgs: (
  ...
  if (arg2 !== undefined) {
    ...
    result.payload = Payload.parse(arg2);
    ...
    if (typeof arg0 === "string") {
      if (arg1 instanceof Error) {
        ...
        // * [msg, payload]
        result.msg = arg0;
        result.payload = Payload.parse(arg1);
      } else {
        // * default: [msg, err]
        result.msg = arg0;
        result.err = objectifyError(arg1);
    ...
    if (arg0 instanceof Error) {
      ...
      // * [payload]
      result.payload = Payload.parse(arg0);
    } else {
